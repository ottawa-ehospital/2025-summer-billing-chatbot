...
export default defineConfig({
  ...
  server: {
    proxy: {
      ...
      '/ws': {
        target: 'wss://realtime-voice-server-f6d6hxbfgde2ghgy.canadacentral-01.azurewebsites.net',
        ws: true
      }
    }
  },
  define: {
    ...
    'import.meta.env.VITE_WEBSOCKET_URL': JSON.stringify('wss://realtime-voice-server-f6d6hxbfgde2ghgy.canadacentral-01.azurewebsites.net')
  }
})
